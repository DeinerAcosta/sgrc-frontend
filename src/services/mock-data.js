...
// PROYECTOS-3255 #3.1/#3.3: el orden de las keys debe coincidir con cfg.cols
// en ReportPage (Object.values indexado). Nuevas columnas prom_h_semanal y
// prom_h_mensual entre h_ejec y pac_prog. Recurso sin actividad usa pct=null.
export const INFORME_PRODUCTIVIDAD = [
  { resource: 'Dr. Rhenals',   type: 'Oftalmólogo', site: 'BQ S2', h_prog: 36, h_ejec: 36, prom_h_semanal: 36, prom_h_mensual: 36, pac_prog: 108, pac_at: 105, pct_cumplimiento: 97 },
  { resource: 'Dr. Gutierrez', type: 'Optómetra',   site: 'BQ S2', h_prog: 60, h_ejec: 60, prom_h_semanal: 60, prom_h_mensual: 60, pac_prog: 110, pac_at: 110, pct_cumplimiento: 100 },
  { resource: 'Dr. Escudero',  type: 'Optómetra',   site: 'BQ S2', h_prog: 54, h_ejec: 48, prom_h_semanal: 48, prom_h_mensual: 48, pac_prog: 99,  pac_at: 80,  pct_cumplimiento: 81 },
  { resource: 'Alba Tete',     type: 'Auxiliar',    site: 'BQ S2', h_prog: 42, h_ejec: 42, prom_h_semanal: 42, prom_h_mensual: 42, pac_prog: 0,   pac_at: 0,   pct_cumplimiento: null },
]
