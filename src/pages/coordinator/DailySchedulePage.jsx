            ...
            <tbody>
              {items.map((it) => (
                <tr key={it.id} className="border-b border-gray-50">
                  <td className="px-3 py-2 text-xs font-medium">{it.start_time}–{it.end_time}</td>
                  <td className="px-3 py-2 text-xs">
                    <div className="font-medium text-gray-800">{it.room?.name}</div>
                    <div className="text-gray-500 capitalize">{it.room?.specialty}</div>
                  </td>
                  <td className="px-3 py-2 text-xs">
                    <div className="font-medium">{it.resource?.name}</div>
